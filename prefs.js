...
function buildPrefsWidget() {
  ...
  make_item(
    "Move focused window to previous/next workspace (false)",
  ...
  make_item(
    "Workspaces thumbnails in overview (true)",
  ...
  make_item(
    "Places extension label to icon (true)",
    "display-places-icon",
    "b"
  );
  make_item(
    "Rounded workspaces icons (false)",
  ...
  make_item(
    "Applications grid icon (view-app-grid-symbolic)",
    "app-grid-icon-name",
    "s"
  );
  ...
  make_item(
    "Right-click to show move-to-workspace arrows (true)",
    "right-click",
    "b"
  );
